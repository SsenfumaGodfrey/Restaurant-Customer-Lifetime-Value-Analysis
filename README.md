...
- [Loyalty Program Performance Analysis](#Loyalty-Program-Performance-Analysis)
...
#### Key Findings
The business shows remarkable gender balance (within 1% revenue difference across all genders) but faces significant operational challenges with 33% revenue loss due to order cancellations and a concerning 49.31% revenue contribution from inactive customers.
...
#### The Path Forward:
The business must prioritize fixing delivery operations while simultaneously reactivating the dormant customer base. Success in these two areas could potentially increase revenue by 40-50% without acquiring a single new customer. Simultaneously, leveraging the January revenue peak and converting July signups into long-term loyal customers will build sustainable growth.

*Most Critical Metric to Watch:* Delivery success rate (currently 35%). Every 5% improvement in successful deliveries could recover approximately 700 million UGX in lost revenue.

Report Generated for Restaurant Management Team
Data Period: 2023 - 2025
*Analysis Methodology: Customer Lifetime Value Framework, RFM Segmentation, Cohort Analysis*
